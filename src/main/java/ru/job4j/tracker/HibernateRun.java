    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Item item = create(new Item(
                    "Learn Hibernate", "only ahead", new Timestamp(1459510232000L)), sf);
            Item itemFirst = new Item(
                    "today work", "for what tomorrow will be beter", new Timestamp(1259510235000L));
            System.out.println(item);
            item.setName("Learn Hibernate and speed.");
            update(item, sf);
            System.out.println(item);
