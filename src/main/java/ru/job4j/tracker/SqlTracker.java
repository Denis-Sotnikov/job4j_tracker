...
public class SqlTracker implements Store {
    ...
    public Item findById(String id) {
        ...
        Item it = new Item();
        it.setName("Отправляемся");
        it.setId(4);
        System.out.println(it.getId());
        Item itu = new Item();
        itu.setName("Отправляемся в путешествие на юга");
        it.setId(4);
        System.out.println(it.getId());
        //tracker.add()
...
//        );
        try (Store tracker = new SqlTracker()) {
            ...
            //System.out.println(tracker.replace("4", itu));sout

            //System.out.println(tracker.delete("7"));

//            for (Item i : tracker.findAll()) {
//                System.out.println(i.getId() + " " + i.getName());
//            }

//            for (Item i : tracker.findByName("buy car")) {
//                System.out.println(i.getId() + " " + i.getName());
//            }
